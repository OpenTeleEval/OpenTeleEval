# Release Management
This document describes the management approach by which official versions of the OpenTeleEval benchmark dataset and evaluation code are released.
## Versioning
The OpenTeleEval project follows the specification of Semantic Versioning 2.0.0 with the following supplemental notes:
...
## Release Process
OpenTeleEval plans to release 2 major versions per year. The specific cadence will be dynamically adjusted based on dataset updates, evaluation task expansion, or community feedback.
